...
import { Notification, INotificationHandler, Request, IRequestHandler } from 'src/mediator/mediator.service';
...
export function NotificationHandler<TNotification extends { new (...args: any[]): Notification }>(
  ...
  return function <TNotificationHandler extends { new (...args: any[]): INotificationHandler<Notification> }>(
